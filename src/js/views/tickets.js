...
class TicketsUI {
	constructor(currency) {
		...
		this.getСurrencySimbol = currency.getСurrencySimbol.bind(currency);
	}
	...
	renderTickets(tickets) {
		...
		let fragment = '';
		const currency = this.getСurrencySimbol();

		tickets.forEach(ticket => {
			// console.log(ticket);
			const tepmlate =TicketsUI.ticketTemplate(ticket, currency);
			fragment += tepmlate;
		})
			...
			<div class="col s12 m6">
	            <div class="card ticket-card">
	              ...
	              <div class="ticket-time-price d-flex align-items-center">
	                <span class="ticket-time-departure departure_at">${ticket.departure_at}</span>
